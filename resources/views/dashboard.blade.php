    ...
    <div class="center items" style="text-align: -webkit-center;">
                ...
                <div class="col-sm-4">
                    <div id="accordion-collapse" data-accordion="collapse">
                        <h5 id="accordion-collapse-heading-1">
                            <button type="button" class="flex items-center justify-between w-25 p-2 font-medium text-center" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
                        ...
                        <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                            <div class="p-1 font-light border border-b-0 border-gray-200 w-25">
